      ...
      <div className="privacy-parent parent">
        <div className="privacy-cont cont">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to rohini plastics, Sr.No.17/1, Shri
                Ganesh Nagar, Sayaji Thakur Marga, Dhawde Wasti, Bhosari, Pune -
                39.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to rohini plastics, accessible
                from{" "}
                <a
                  href="https://rohini-plastics.vercel.app"
         ...
         {" "}
          ...
          <ul>
            <li>By email: rohiniplastic1@gmail.com</li>
          </ul>
        </div>
      </div>
    </>
